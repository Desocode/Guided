...
>>|cRXP_WARN_Do not accept the escort quest, it's not worth the time|r
...
.goto Feralas,53.353,55.696
.abandon 2767,1 >> Abandon Rescue OOX-22/FE!
step << Hunter
#season 2
...
>>Grind a little bit if you're close to having enough money for a mount (90g) << !Paladin !Warlock
step << !Mage !Druid
.goto Feralas,30.239,43.251
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Fyldren Moonfeather|r
...
step
#completewith FlyTan
.hs >> Hearth to Feathermoon if your Hearthstone is off cooldown
>>|cRXP_BUY_Buy food/water if needed|r << !Warrior !Rogue
>>|cRXP_BUY_Buy food if needed|r << Warrior/Rogue
step
