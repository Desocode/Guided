...
.goto 1437,37.844,51.291
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Ormer Ironbraid|r
>>|cRXP_WARN_Keep the bow you get as reward from this quest. You will train bow skill shortly|r << Dwarf Hunter
...
#softcore
#completewith next
.deathskip >> Die and respawn at the Spirit Healer in central Wetlands
...
step
#xprate <1.5 << Rogue/Priest/Hunter/Warrior
#loop
...
.target Rethiel the Greenwarden
.isQuestComplete 276
step << Rogue/Hunter/Priest/Warrior
#xprate >1.59
#sticky
#completewith next
...
step
#season 1 << Priest/Rogue/Hunter/Warrior
#loop
.goto Wetlands,43.39,28.57,0
.goto Wetlands,46.55,24.18,0
.goto Wetlands,44.20,25.39,0
...
.train 399965,1
.dungeon !SFK
>>You will now go to get your |T236270:0|t[|cRXP_FRIENDLY_Deadly Brew|r] and |T132287:0|t[|cRXP_FRIENDLY_Envenom|r] runes. |cRXP_WARN_They are extremely powerful and you will use them for the rest of the game|r
...
.link /run InviteUnit("aa");C_Timer.After(1,function() LeaveParty() end) >> |cRXP_WARN_Click here to Copy + Paste this macro once you're inside The SFK to ghetto Hearth to Southshore|r
...
#optional
#completewith Search
.hs >> Hearthstone to Menethil Harbor
step << Dwarf Hunter
#softcore
>>|cRXP_WARN_Save your hearthstone cooldown! You will need it to get back from Darnassus shortly|r
.deathskip >> Die and Respawn at the Spirit Healer
.target Spirit Healer
step << !NightElf
#softcore
.goto Wetlands,29.2,37.4
>>|cRXP_WARN_Travel to the spot marked on your map and die. Make sure you're not east of it or you might end up going the wrong way|r
.deathskip >> Die and Respawn at the Spirit Healer
step << !NightElf
.goto Wetlands,12.1,51.3,100 >> Travel Back to Menethil Harbor
step
.goto Wetlands,10.843,60.435
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Archaeologist Flagongut|r upstairs
...
.dungeon SFK
step << !NightElf
.goto Wetlands,4.82,57.26
.zone Darkshore >> Travel to the end of the dock. Take the boat to Auberdine
step << !NightElf
...
.goto Darkshore,37.6,43.8
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Syrnoya|r
.turnin 78195 >> Turn in Secrets of Elune
.target Syrnoya
step << Human Priest/Dwarf Priest
.goto Darkshore,37.74,43.89
>>|cRXP_WARN_You can now get a second meditation buff by yourself by kneeling next to any moonwell in the world. Having two meditation buffs is necessary to use|r |T135975:0|t[|cRXP_FRIENDLY_Prophecies|r] |cRXP_WARN_which unlock new runes|r
.aura 419307 >>|cRXP_WARN_Stand next to the moonwell, type /kneel in your chatbox and wait a couple seconds|r
>>|cRXP_WARN_You will receive the|r |T136057:0|t[Meditation on Elune] |cRXP_WARN_buff|r
step << Human Priest/Dwarf Priest
#completewith next
.train 402852 >> Use the |T135975:0|t[|cRXP_FRIENDLY_Prophecy of a Desecrated Citadel|r] to train |T237570:0|t[Homunculi]
.itemcount 205947,1
.use 205947
.train 402852,1
step << !NightElf
...
.fp >> Get the Darnassus Flight Path
.target Vesprystus
step << !NightElf
#completewith next
#season 2 << !Mage !Warlock !Paladin
#season 1 << Mage/Warlock/Paladin
...
.target Jandria
step << Dwarf Hunter
.goto Darnassus,57.2,45.4
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Ilyenia Moonfire|r
.train 264 >> Train Bows
.target Ilyenia Moonfire
step << !NightElf
.hs >> Hearthstone to Lakeshire << !Mage !Warlock !Paladin
.hs >> Hearthstone to Stormwind << Mage/Warlock/Paladin
step << Druid
#optional
#completewith next
.cast 18960 >> Cast Teleport: Moonglade
...
step
.goto Wetlands,10.69,60.95
.hs >> Hearth to Menethil Harbor << !Dwarf Hunter/!Dwarf Priest/!Human Priest
.hs >> Hearth to Stormwind City << Dwarf Hunter/Dwarf Priest/Human Priest
.subzoneskip 150
.subzoneskip 2103
.subzoneskip 2104
.zoneskip Loch Modan
